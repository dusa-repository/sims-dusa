...
public class CVisitaSocial extends CGenerico {
	...
	public void inicializar() throws IOException {
		...
		Botonera botonera = new Botonera() {
			...
			public void limpiar() {
			    ...
			    SpinnerCuantosAmbientes.setPlaceholder("Seleccione una cantidad");
    ...
    public void condicionDeVivienda() {
        ...
        showNotify("Has seleccionado " + condicionVivienda, cmbCondicionVivienda);
    }
    ...
    public void seleccione(CheckEvent event) {
       ...
       showNotify("Has seleccionado " + seleccionados, checkEstructura1.getParent());
    }
    ...
    public void servicioElectrico() {
        ...
        showNotify("Has seleccionado " + selectedItem.getLabel(), radiogroupServicioElectrico.getParent());
    }
    ...
    public void gastosSeparados() {
        ...
        showNotify("Has seleccionado " + selectedItem.getLabel(), radiogroupGastosSeparados.getParent());
    }
	...
	//Spinner
	 @Listen("onChange = #SpinnerCuantosAmbientes")
	    public void cantidadAmbientes() {
	        ...
	        showNotify("Ha Seleccionado: " + cuantosAmbientes, SpinnerCuantosAmbientes);
	    }
	//Spinner
